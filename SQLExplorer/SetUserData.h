...
namespace SQLExplorer {
	...
	public ref class SetUserData : public System::Windows::Forms::Form
	{
	public:
		const char** host;
		const char** user;
		...
		SetUserData(void);
		SetUserData(const char** host, const char** user, const char** password, const char** dbName);
...
#pragma region Windows Form Designer generated code
		void InitializeComponent(void)
		{
			...
			this->btn_submit->Click += gcnew System::EventHandler(this, &SetUserData::button1_Click);
			// 
			// label1
			// 
