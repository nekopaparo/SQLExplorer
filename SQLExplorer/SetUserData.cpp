...
SQLExplorer::SetUserData::SetUserData(void)
{
	InitializeComponent();
...
SQLExplorer::SetUserData::SetUserData(const char** host, const char** user, const char** password, const char** dbName)
{
	InitializeComponent();
...
SQLExplorer::SetUserData::~SetUserData()
{
	if (components)
	{
		delete components;
...
System::Void SQLExplorer::SetUserData::button1_Click(System::Object^ sender, System::EventArgs^ e) {
	if (host == NULL)
	{
